...
- Stage 3 currently resolves only clean highlight or underline candidates, preserves anchor-local `resolved_span_text`, exposes widened `semantic_entry_text`, and now differentiates unresolved cases into deterministic families such as `missing-anchor-and-empty-text-unresolved`, `ambiguous-underline-anchor-unresolved`, `ambiguous-highlight-anchor-unresolved`, `ambiguous-anchor-unknown-mark-unresolved`, `marginalia-unresolved`, `below-stage1-confidence-threshold-unresolved`, `enclosure-like-unknown-mark-unresolved`, `enclosure-like-underline-unresolved`, and `stage1-uncertainty-unresolved`, with `unresolved-anchor-reference-unresolved`, `enclosure-like-highlight-unresolved`, and `missing-stage1-detection-confidence-unresolved` available but unpopulated on the current corrected-root proof surface.

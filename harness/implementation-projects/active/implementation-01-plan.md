...
Implemented Stage 3 command shape:

```text
python -m novel_and_hilite_extraction stage3-annotation-interpret \
   --run-root <existing-stage1-run-root>
```
...
- Passed: bounded Stage 3 validation on the corrected anchor-suite root at `C:\Users\madis\AppData\Local\Temp\novel-stage1-anchor-suite-v2-bd4c44ec-4ded-4efd-b06f-9c8c4154a2ce\anchor-suite-v2`, where `python -m novel_and_hilite_extraction stage3-annotation-interpret --run-root <root>` emitted 122 interpretation records with 5 resolved and 117 unresolved, promoted `pdf-page-0020-right` candidates `mark-candidate-0004` and `mark-candidate-0010`, retained unresolved ambiguity on `pdf-page-0024-left` for candidates `mark-candidate-0001` through `mark-candidate-0004`, forced no resolved enclosure-like interpretation on that surface, and left `pdf-page-0025-right`, `pdf-page-0028-left`, and `pdf-page-0028-right` with zero resolved interpretations.
